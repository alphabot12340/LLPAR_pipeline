...
def torch_safe_load(weight):
    """
    Safe load for older YOLO/DEYOLO checkpoints under PyTorch 2.6+
    Allows custom model classes (e.g., DetectionModel) to be loaded.
    """
    ...
    # Allow custom DEYOLO model class
    torch.serialization.add_safe_globals([DetectionModel])

    check_suffix(file=weight, suffix='.pt')
    file = attempt_download_asset(weight)

    # IMPORTANT: Set weights_only=False to bypass PyTorch 2.6 restriction
